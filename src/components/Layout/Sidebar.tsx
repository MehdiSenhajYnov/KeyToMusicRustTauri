...
export function Sidebar() {
  return (
    <aside className="w-56 bg-bg-secondary border-r border-border-color flex flex-col shrink-0 overflow-y-auto">
      <ProfileSelector />
      ...
      <div className="border-t border-border-color flex-1">
        <NowPlaying />
      </div>
    </aside>
  );
